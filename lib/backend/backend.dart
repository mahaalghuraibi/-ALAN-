...
import 'schema/alan_record.dart';
...
export 'schema/alan_record.dart';
...
/// Functions to query AlanRecords (as a Stream and as a Future).
Future<int> queryAlanRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      AlanRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<AlanRecord>> queryAlanRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      AlanRecord.collection,
      AlanRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<AlanRecord>> queryAlanRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
