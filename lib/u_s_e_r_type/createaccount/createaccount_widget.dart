...
class _CreateaccountWidgetState extends State<CreateaccountWidget> {
  ...
  void initState() {
    ...
    _model.passw2TextFieldTextController ??= TextEditingController();
    _model.passw2TextFieldFocusNode ??= FocusNode();
                ...
                Column(
                  ...
                  children: [
                    Align(
                      ...
                      child: Text(
                        FFLocalizations.of(context).getText(
                          'rba7ef0y' /* أدخل بياناتك لإنشاء حساب جديد */,
                        ),
                        textAlign: TextAlign.center,
                                ...
                                children: [
                                      ...
                                      TextFormField(
                                        ...
                                        decoration: InputDecoration(
                                          hintText: FFLocalizations.of(context)
                                              .getText(
                                            'hgzzfeao' /* أدخل بريدك الإلكتروني */,
                                          ),
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      TextFormField(
                                        controller: _model
                                            .passw2TextFieldTextController,
                                        focusNode:
                                            _model.passw2TextFieldFocusNode,
                                        onChanged: (_) => EasyDebounce.debounce(
                                          '_model.passw2TextFieldTextController',
                                          Duration(milliseconds: 100),
                                          () => safeSetState(() {}),
                                        ),
                                        autofocus: false,
                                        ...
                                        textInputAction: TextInputAction.next,
                                        obscureText:
                                            !_model.passw2TextFieldVisibility,
                                        decoration: InputDecoration(
                                          hintText: FFLocalizations.of(context)
                                              .getText(
                                            'on92t1mz' /* أعد إدخال كلمة المرور */,
                                          ),
                                          hintStyle: FlutterFlowTheme.of(
                                                  context)
                                              .bodyMedium
                                      ...
                                      if (_model.passw2TextFieldTextController
                                              .text !=
                                          _model.passwTextFieldTextController
                                              .text)
                                        Align(
                                          ...
                                          child: Text(
                                            FFLocalizations.of(context).getText(
                                              'f7ul6a34' /* كلمة المرور غير متطابقة */,
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                          ...
                                          Align(
                                            ...
                                            child: Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'd6dasgbo' /* يجب اختيار نوع الحساب  */,
                                              ),
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyMedium
                          ...
                          Column(
                            ...
                            children: [
                              FFButtonWidget(
                                ...
                                text: FFLocalizations.of(context).getText(
                                  'knzgqedu' /*  التسجيل باستخدام Google */,
                                ),
                                icon: FaIcon(
                              ...
                              Padding(
                                ...
                                child: FFButtonWidget(
                                  ...
                                  text: FFLocalizations.of(context).getText(
                                    'herr8l8c' /*  التسجيل باستخدام Apple */,
                                  ),
                                  icon: Icon(
                                    Icons.apple,
                                    size: 30.0,
