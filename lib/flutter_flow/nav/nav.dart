...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: PlaceWidget.routeName,
          path: PlaceWidget.routePath,
        ...
        FFRoute(
          name: WelcompageWidget.routeName,
          path: WelcompageWidget.routePath,
          builder: (context, params) => WelcompageWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          builder: (context, params) =>
              params.isEmpty ? NavBarPage(initialPage: 'Ai') : AiWidget(),
        )
